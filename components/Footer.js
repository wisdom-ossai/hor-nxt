                            ...
                            <div className="row clearfix">
                                <div className="footer-column col-md-7 col-sm-5 col-xs-12">
                                    <div className="footer-widget adress-widget">
                                        <h3>Address</h3>
                                        <div className="text">Michael I. Days 3756 <br />Preston Street Wichita, KS 67213 <br />- <a href="#">USA</a></div>
                                            <ul>
                                                <li><a href="#"><span className="theme_color fa fa-phone"></span> &ensp; +123 456 789 000</a></li>
                                                <li><a href="#"><span className="theme_color fa fa-fax"></span> &ensp; +000 123 456 789</a></li>
                                                <li><a href="#"><span className="theme_color fa fa-envelope"></span> &ensp; info@incles.com</a></li>
                                            </ul>
                                    </div>
                                        </div>
                                    ...
                                    <div className="footer-widget post-widget">
                                                ...
                                                <ul>
                                                    <li className="recent-post">
                                                        <span className="date">14 May 2019</span>
                                ...
                                <div className="footer-column col-md-6 col-sm-6 col-xs-12">
                                            <div className="footer-widget tweet-widget">
                                                ...
                                                <div className="twitter-post">
                                                    ...
                                                    <span className="date">15 May 2019</span>
                                                </div>
                                                ...
                                                <div className="twitter-post">
                                                    ...
                                                    <span className="date">12 May 2019</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
